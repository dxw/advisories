<div class="search-form">
    <form role="search" method="get" id="searchform" class="form-search" action="<?php echo home_url('/') ?>">
        ...
        <?php if(is_search()) { ?>
            <input type="radio" name="post_type" value="all" id="all" <?php checked( $_GET['post_type'], 'all'); checked( $_GET['post_type'], '') ?>/><label for="all">All</label>
            <input type="radio" name="post_type" value="advisories" id="advisories" <?php checked( $_GET['post_type'], 'advisories') ?>/><label for="advisories">Advisories</label>
            <input type="radio" name="post_type" value="plugins" id="plugins" <?php checked( $_GET['post_type'], 'plugins') ?>/><label for="plugins">Plugins</label>
        <?php } ?>
    </form>
</div>
