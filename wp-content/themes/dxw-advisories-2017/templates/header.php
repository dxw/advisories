<header class="header group" role="banner">
    <div class="row">
        ...
        <a class="main-nav-toggle" id="js-main-navigation-toggle" aria-hidden="true" href="#">Menu</a>
        <nav class="main-navigation" role="navigation" id="js-main-navigation">
            <?php
            wp_nav_menu( array(
