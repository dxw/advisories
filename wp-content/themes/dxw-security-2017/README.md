...
```
$registrar->addInstance(\Dxw\DxwSecurity2017\RegisterStuff::class, new \Dxw\DxwSecurity2017\RegisterStuff());
```
...
```
$registrar->addInstance(\Namespace\DxwSecurity2017\HelperFunctions::class, new \Namespace\DxwSecurity2017\HelperFunctions(
