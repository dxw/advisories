    ...
    public function displayIfSuperAdmin()
    {
        ...
        <section class="admin-tools-container">
            ...
            <ul class="email-links">
                <li>
                    <a href="#" class="send_email_button email-button icon-mail" id="email_fd" data-subject="<?php h()->the_title_for_email(); ?>" data-body="textarea.report_email">Full Disclosure</a>
                </li>
                <li>
                    <a href="#" class="send_email_button email-button icon-mail" id="email_wpscan" data-subject="<?php h()->the_title_for_email(); ?>" data-body="textarea.report_email">WP Scan</a>
                </li>
                <li>
                    <a href="#" class="send_email_button email-button icon-mail" id="email_dxw_wp_sec" data-subject="<?php h()->the_title_for_email(); ?>" data-body="textarea.report_email">dxw WP Security</a>
                </li>
            </ul>
            
            <h3>Report emails</h3>
            <a href="#" class="send_email_button email-button icon-mail" id="email_wp_plugins" data-subject="<?php h()->the_title_for_email(); ?>" data-body="textarea.report_email">WP Plugins</a>
